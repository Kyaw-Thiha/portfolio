...
function Frame({
  ...
  useCursor(hovered);
  useFrame((state, dt) =>
    easing.damp(portal.current, "blend", chosenItem === id ? 1 : 0, 0.2, dt),
  );

  return (
    <group {...props}>
      <Text
        /*font={suspend(medium).default}*/ fontSize={0.3}
        anchorY="top"
        anchorX="left"
        lineHeight={0.8}
      ...
      <Text
        /*font={suspend(regular).default}*/ fontSize={0.1}
        anchorX="right"
      ...
      <Text
        /*font={suspend(regular).default}*/ fontSize={0.04}
        anchorX="right"
      ...
      <mesh
        ...
        onDoubleClick={(e) =>
          (
            ...
            e.stopPropagation(), setChosenItem(e.object.name)
          )
        }
